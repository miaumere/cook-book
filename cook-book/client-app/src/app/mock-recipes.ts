...
export const RECIPES: Recipe[] = [
  ...
  { id: 2, title: 'Pyzy', description: 'pyzy są kkk', recipe: 'oto sposób robienia pyz', category: 'obiady', },
  { id: 3, title: 'Sałatka', description: 'salatke zrobic czaaas', recipe: 'oto sposób robienia salatki', category: 'sałatki', },
  { id: 4, title: 'Sushi', description: 'sushi jest kkk', recipe: 'oto sposób robienia sushi', category: 'obiady', },
